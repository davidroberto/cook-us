...
export class GetConversationMessagesController {
  ...
  @ApiOperation({ summary: "Récupérer les messages d'une conversation (paginés)" })
  ...
  @ApiQuery({ name: "limit", required: false, type: Number, description: "Nombre de messages par page (défaut: 20)" })
  @ApiResponse({ status: 200, description: "Messages paginés (du plus récent au plus ancien)" })
